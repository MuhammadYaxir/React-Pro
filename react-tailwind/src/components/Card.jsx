...
function Card({username, price="55"}) {
  return (
    <>
      <div className="flex font-sans bg-white mb-2">
        <div className="flex-none w-56 relative">
          <img
            src="https://img.freepik.com/free-photo/raw-eggplants-ready-be-cooked_23-2150410388.jpg?w=826&t=st=1704114782~exp=1704115382~hmac=d2d054ef8a8802ce0eaf7a12512747b061018d55f5360060deae971eda0db75e"
            alt=""
